...
--
-- Name: awards_id_seq; Type: SEQUENCE; Schema: public; Owner: vagrant
--
...
ALTER TABLE awards_id_seq OWNER TO vagrant;

--
-- Name: awards_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: vagrant
--
...
COPY awards (name, year, id, winner_id) FROM stdin;
IIHS Safety Award	2015	1	49
IIHS Safety Award	2015	3	50
\.


--
-- Name: awards_id_seq; Type: SEQUENCE SET; Schema: public; Owner: vagrant
--

SELECT pg_catalog.setval('awards_id_seq', 3, true);
...
--
-- Name: awards_pkey; Type: CONSTRAINT; Schema: public; Owner: vagrant
--
...
--
-- Name: awards_winner_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: vagrant
--
